...
if (isset($_GET['startDate']) && isset($_GET['endDate'])) {
    ...
    $sql = "SELECT ID, fecha, sensor, temperatura_ambiente FROM tabla_temperatura_ambiente WHERE fecha BETWEEN '$startDate' AND '$endDate'";
  ...
  class PDF extends FPDF
    {
        function Header()
        {
            ...
            $this->SetX(60);
            $this->Cell(100, 80, utf8_decode("Reporte de Temperatura del Ambiente"), 0, 0, "C", 0);
            ...
            $this->Cell(70, 10, 'Temperatura del Ambiente', 1, 0, 'C', 1);
            $this->Ln();
        }
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(70, 10, $row['temperatura_ambiente'], 1);
        $pdf->Ln();
    }
