...
if (isset($_GET['startDate']) && isset($_GET['endDate'])) {
    ...
    $sql = "SELECT ID, fecha, modelo, humedad_ambiente FROM tabla_humedad_ambiente WHERE fecha BETWEEN '$startDate' AND '$endDate'";
    ...
    class PDF extends FPDF
    {
        function Header()
        {
            ...
            $this->SetX(60);
            $this->Cell(100, 80, utf8_decode("Reporte de Humedad del Ambiente"), 0, 0, "C", 0);
            ...
            $this->Cell(70, 10, 'Humedad del Ambiente', 1, 0, 'C', 1);
            $this->Ln();
        }
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(50, 10, $row['modelo'], 1, 0, 'C');
        $pdf->Cell(70, 10, $row['humedad_ambiente'], 1, 0, 'C');
        $pdf->Ln();
    }
