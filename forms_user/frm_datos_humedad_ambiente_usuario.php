            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Datos de Humedad del Ambiente
                        </h6>
                        <div class="container-fluid pt-4 px-4">
                            <div class="bg-light rounded h-100 p-4">
                                <div class="mb-3">
                            ...
                            <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
                             ...
                             <script>
                                function exportToPDF() {
                                    ...
                                    window.open("../reportes/frm_imprimir_humedad_ambiente.php?startDate=" + startDate + "&endDate=" + endDate);
                                }
                            
                               $(document).ready(function() {
                                    var tabla = $('#miTabla').DataTable({
                                        "ajax": {
                                            "url": "../recursos/get_info_humedad_ambiente.php",
                                            "dataSrc": ""
                                        },
                                        "columns": [
                                            { "data": "ID" },
