            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Datos de de Luminosidad
                        </h6>
                        <div class="container-fluid pt-4 px-4">
                            <div class="bg-light rounded h-100 p-4">
                                <div class="mb-3">
                            ...
                            <script>
                                function exportToPDF() {
                                    ...
                                    window.open("../reportes/frm_imprimir_luminosidad.php?startDate=" + startDate + "&endDate=" + endDate);
                                }
                            
                               $(document).ready(function() {
                                    var tabla = $('#miTabla').DataTable({
                                        "ajax": {
                                            "url": "../recursos/get_info_luminosidad.php",
                                            "dataSrc": ""
                                        },
                                        "columns": [
                                            { "data": "ID" },
